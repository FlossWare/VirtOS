...
**v0.59** (as of 2026-05-26)

- **Major**: 0 (pre-1.0 alpha/beta phase)
- **Minor**: 59 (auto-incremented by CD workflow)
...
|------|-------------------|
| `VERSION` | 0.59 |
| `packages/virtos-tools/virtos-tools.tcz.info` | Version: 0.59 |
| `packages/virtos-jplatform/virtos-jplatform.tcz.info` | Version: 0.59 |
| Git tag | v0.59 |
| GitHub Release | VirtOS v0.59 |
...
virtos-create-vm version 0.59

$ virtos-tui --version
virtos-tui version 0.59
```
